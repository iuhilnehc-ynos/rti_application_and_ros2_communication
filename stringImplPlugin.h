...
#ifndef stringImplPlugin_1574212639_h
#define stringImplPlugin_1574212639_h
...
#define std_msgs_msg_dds__String__cPlugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
#define std_msgs_msg_dds__String__cPlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define std_msgs_msg_dds__String__cPlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

#define std_msgs_msg_dds__String__cPlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define std_msgs_msg_dds__String__cPlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
Support functions:
* -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern std_msgs_msg_dds__String__c*
...
std_msgs_msg_dds__String__cPluginSupport_copy_data(
    std_msgs_msg_dds__String__c *out,
    const std_msgs_msg_dds__String__c *in);
...
NDDSUSERDllExport extern RTIBool
std_msgs_msg_dds__String__cPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
...
NDDSUSERDllExport extern RTIBool 
std_msgs_msg_dds__String__cPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    std_msgs_msg_dds__String__c * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
NDDSUSERDllExport extern RTIBool 
std_msgs_msg_dds__String__cPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    std_msgs_msg_dds__String__c ** sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
std_msgs_msg_dds__String__cPlugin_new(void);

NDDSUSERDllExport extern void
std_msgs_msg_dds__String__cPlugin_delete(struct PRESTypePlugin *);
...
#endif /* stringImplPlugin_1574212639_h */
